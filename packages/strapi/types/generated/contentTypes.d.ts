...
export interface ApiApplicationApplication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    code: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    coverLetter: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiBirthBirth extends Struct.CollectionTypeSchema {
  collectionName: 'births';
  info: {
    description: '';
    displayName: 'Birth';
    pluralName: 'births';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::birth.birth'> &
      Schema.Attribute.Private;
...
export interface ApiCoverLetterCoverLetter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    formalClosing: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    opening: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    internships: Schema.Attribute.Relation<
      'oneToMany',
      'api::occupation.occupation'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    work: Schema.Attribute.Relation<'oneToMany', 'api::occupation.occupation'>;
  };
}

export interface ApiLanguageValueLanguageValue
  extends Struct.CollectionTypeSchema {
  collectionName: 'language_values';
  info: {
    displayName: 'LanguageValue';
    pluralName: 'language-values';
    singularName: 'language-value';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::language-value.language-value'
    >;
...
export interface ApiMainApplicationMainApplication
  extends Struct.SingleTypeSchema {
  collectionName: 'main_applications';
  info: {
    description: '';
    displayName: 'mainApplication';
    pluralName: 'main-applications';
    singularName: 'main-application';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::main-application.main-application'
    > &
      Schema.Attribute.Private;
    profile: Schema.Attribute.Relation<'oneToOne', 'api::profile.profile'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOccupationOccupation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_range: Schema.Attribute.Relation<
      'oneToOne',
      'api::date-range.date-range'
    >;
    locale: Schema.Attribute.String;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    tasks: Schema.Attribute.Relation<'oneToMany', 'api::value.value'>;
...
export interface ApiPersonalPersonal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contacts: Schema.Attribute.Relation<'oneToMany', 'api::value.value'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    firstName: Schema.Attribute.String;
...
export interface ApiPortfolioPortfolio extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutMe: Schema.Attribute.Component<'basic.text-element', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    header: Schema.Attribute.Component<'portfolio.header', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    >;
    nowListening: Schema.Attribute.Component<'portfolio.now-playing', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    skillList: Schema.Attribute.Component<'portfolio.tag-list', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    toLearnList: Schema.Attribute.Component<'basic.text-element', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    interests: Schema.Attribute.Relation<'manyToMany', 'api::value.value'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    softwares: Schema.Attribute.Relation<'manyToMany', 'api::value.value'>;
    strengths: Schema.Attribute.Relation<'manyToMany', 'api::value.value'>;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<
      ['work in progress', 'completed', 'planned', 'abandoned', 'paused']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiRecipientRecipient extends Struct.CollectionTypeSchema {
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    link: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tag.tag'> &
      Schema.Attribute.Private;
    npmLink: Schema.Attribute.String;
...
export interface ApiValueValue extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    occupation: Schema.Attribute.Relation<
      'manyToOne',
      'api::occupation.occupation'
    >;
    profileInterests: Schema.Attribute.Relation<
      'manyToMany',
      'api::profile.profile'
    >;
    profileSoftwares: Schema.Attribute.Relation<
      'manyToMany',
      'api::profile.profile'
    >;
    profilesStrengths: Schema.Attribute.Relation<
      'manyToMany',
      'api::profile.profile'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::birth.birth': ApiBirthBirth;
      'api::company.company': ApiCompanyCompany;
      'api::cover-letter.cover-letter': ApiCoverLetterCoverLetter;
      'api::date-range.date-range': ApiDateRangeDateRange;
      'api::experience.experience': ApiExperienceExperience;
      'api::language-value.language-value': ApiLanguageValueLanguageValue;
      'api::main-application.main-application': ApiMainApplicationMainApplication;
